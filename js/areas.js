...
const areaCirculo = (radio) => {
  ...
  resultado.textContent = `Area = ${Math.round(area, 2)}`;
};
...
const areaRectangulo = (base, altura) => {
  ...
  document.querySelector(
    ".area_rectangulo_num1"
  ).textContent = `Base = ${base}`;
  document.querySelector(
    ".area_rectangulo_num2"
  ).textContent = `Altura = ${altura}`;
...
const areaCilindro = (radio, altura) => {
  ...
  document.querySelector(
    ".area_cilindro_num1"
  ).textContent = `Radio = ${radio}`;
  document.querySelector(
    ".area_cilindro_num2"
  ).textContent = `Altura = ${altura}`;
  document.querySelector(
    ".area_cilindro_resultado"
  ).textContent = `Resultado = ${Math.round(area)}`;
};
...
const areaCono = (radio, generatriz) => {
  ...
  document.querySelector(
    ".area_cono_num2"
  ).textContent = `Generatriz = ${generatriz}`;
  document.querySelector(
    ".area_cono_resultado"
  ).textContent = `Resultado = ${Math.round(area)}`;
};
...
const areaPrisma = (lado, altura) => {
  ...
  document.querySelector(
    ".area_prisma_resultado"
  ).textContent = `Area = ${Math.round(altura, 2)}`;
};
...
const areaPiramide = (lado, altura) => {
  ...
  document.querySelector(
    ".area_piramide_resultado"
  ).textContent = `Area = ${area}`;
};
