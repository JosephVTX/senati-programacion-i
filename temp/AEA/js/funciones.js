...
function totalImpuesto(){
    ...
    let btnImpuesto = document.querySelector("#form_impuesto")
    let subtotalElemento = document.querySelector(".subtotal-ipt")
    let porcentajeElemento = document.querySelector(".porcentaje-ipt")

    btnImpuesto.addEventListener("submit", (e)=> {

        e.preventDefault()
        let importeIgv = subtotalElemento.value * (porcentajeElemento.value / 100)
        document.querySelector(".subtotal").textContent = subtotalElemento.value
        document.querySelector(".importe_igv").textContent = importeIgv
        document.querySelector(".total_impuesto").textContent = parseInt(subtotalElemento.value) + importeIgv
